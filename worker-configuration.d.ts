/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9ccc662788b9d085f7f46ab53f5ea602)
// Runtime types generated with workerd@1.20260911.1 2026-09-07 
interface __BaseEnv_Env {
	DB: D1Database;
	ASK_LIMIT: RateLimit;
	VOTE_LIMIT: RateLimit;
	DEVICE_ISSUE_LIMIT: RateLimit;
	ASK_DEVICE_LIMIT: RateLimit;
	VOTE_DEVICE_LIMIT: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	TRANSLATION_MODEL: "@cf/google/gemma-4-26b-a4b-it";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRANSLATION_MODEL" | "TRANSLATION_TARGET_LANG" | "TRANSLATION_SOURCE_LANG" | "TRANSLATION_CONTEXT" | "ROOM_LOCATION_HINT" | "PRIVACY_OPERATOR" | "PRIVACY_CONTACT">> {}
}
